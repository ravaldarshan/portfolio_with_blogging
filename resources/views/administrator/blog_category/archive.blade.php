...
@section('content')
    @push('section_header')
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="{{ route('admin.category_blog') }}">Category Blog</a></div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="col-4" style="display: flex; justify-content: flex-end;">
                        <a href="{{ route('admin.category_blog') }}" class="btn btn-primary mx-3">Return</a>
                    </div>
                </div>
                <div class="card-body">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var data_table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.category_blog.getDataArchives') }}',
                    dataType: "JSON",
                    type: "GET",
                    data: function(d) {}
            ...
            $(document).on('click', '.delete', function(event) {
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "GET",
                            url: "{{ route('admin.category_blog.forceDelete') }}",
                            data: {
                                "_token": "{{ csrf_token() }}",
                                "_method": "GET",
                                "id": id,
            ...
            $(document).on('click', '.restore', function(event) {
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "PUT",
                            url: "{{ route('admin.category_blog.restore') }}",
                            data: {
                                "_token": "{{ csrf_token() }}",
                                "_method": "PUT",
                                "id": id,

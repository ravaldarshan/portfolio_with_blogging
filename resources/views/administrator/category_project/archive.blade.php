        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="col-4" style="display: flex; justify-content: flex-end;">
                    <a href="{{route('admin.category_project')}}" class="btn btn-primary mx-3">Return</a>
                </div>
            </div>
            <div class="card-body">
        ...
        $(document).on('click', '.delete', function(event) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "GET",
                        url: "{{ route('admin.category_project.forceDelete') }}",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            "_method": "GET",
                            "id": id,
        ...
        $(document).on('click', '.restore', function(event) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "PUT",
                        url: "{{ route('admin.category_project.restore') }}",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            "_method": "PUT",
                            "id": id,

...
@section('content')
    ...
    <div class="card">
        <div class="card-content">
            <div class="card-body">
                <form action="{{ route('admin.category_blog.update') }}" method="post" enctype="multipart/form-data" class="form"
                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-end">
                            ...
                            <a href="{{ route('admin.category_blog') }}" class="btn btn-danger me-1 mb-1">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            async function validateRemoteNama() {
                const inputNama = $('#inputNama');
                const remoteValidationUrl = "{{ route('admin.category_blog.checkNama') }}";

...
@section('content')
                            ...
                            <div class="form-group mandatory">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="inputCategoryProjectName"
                                        value="{{ $data->category->nama }}" readonly>
                                    <div class="input-group-append">
                                        <a href="#" class="btn btn-secondary data_disabled" data-toggle="modal"
                                            data-target="#modalCategoryProject" disabled>
                                            <i class="fas fa-search"></i>
                                        </a>
                                    </div>
                                    <input type="text" class="d-none" name="category" id="inputCategoryProject"
                                        value="{{ $data->category->id }}" data-parsley-required="true"
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" id="inputDatePosting" class="form-control"
                                    value="{{ date('d-m-Y', strtotime($data->posting_date)) }}"
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" id="inputTitle" class="form-control" placeholder="Enter Title"
                                    value="{{ $data->title }}" name="title" autocomplete="off"
                                    data-parsley-required="true" readonly>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <div class="mt-3">
                                        <label for="otherPicturesInputFile" class="btn btn-light btn-file data_disabled">
    ...
    {{-- @include('administrator.blog.modal.category_project') --}}
    <!-- Basic Tables end -->
@endsection
...
@push('js')
    <script>
        ...
        const previewContainerotherPictures = document.querySelector(".fileinput-preview-other_pictures");;P
